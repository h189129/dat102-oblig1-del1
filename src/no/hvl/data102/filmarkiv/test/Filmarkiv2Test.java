...
public class Filmarkiv2Test { // Testklassen

    private Filmarkiv2 arkiv;  
    
    // Film-objekter til testformål
    private Film film1;
    private Film film2;
    private Film film3;
    ...
    @BeforeEach
    public void setup() {
        // Initialiser arkivet og filmene før hver test
    ...
    public void testLeggTilFilm() {
        // Test at arkivet starter tomt
        assertEquals(0, arkiv.antall(), "Arkiv skal starte tomt");

        // Legger til en film og tester at antall oppdateres
        arkiv.leggTilFilm(film1);
        assertEquals(1, arkiv.antall(), "Arkiv skal inneholde én film etter innlegging");
        assertEquals(film1, arkiv.finnFilm(1), "Film1 skal kunne hentes ut ved filmnummer");

        // Legg til enda en film og test igjen
        arkiv.leggTilFilm(film2);
        assertEquals(2, arkiv.antall(), "Arkiv skal inneholde to filmer");
        assertEquals(film2, arkiv.finnFilm(2), "Film2 skal kunne hentes ut ved filmnummer");
    }
